    ...
    <div className="container mx-auto px-4 max-w-5xl">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 items-center">
        <div className="relative col-span-3">
          <img
            src={`${import.meta.env.BASE_URL}images/products-img__green.jpg`}
        ...
        <div className="relative col-span-2 flex justify-end mt-12 md:mt-0">
          <img
            src={`${import.meta.env.BASE_URL}images/products-img__peach.jpg`}
          ...
          <div className="bg-white p-4 shadow-2xl rounded-lg w-80 h-60 flex justify-center items-center">
            <img
              src={`${import.meta.env.BASE_URL}images/products-intro__img.png`}
    ...
    <div className="container mx-auto px-4 max-w-5xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-5">
          <img
            src={`${import.meta.env.BASE_URL}images/instruct-img.jpg`}
    ...
    <div className="container mx-auto px-4 max-w-4xl text-center ">
      ...
      <div className="relative flex flex-col md:flex-row items-center gap-16 mb-1 xl:mb-45">
        ...
        <div className="md:w-1/2">
          <img
            src={`${import.meta.env.BASE_URL}images/rule-img1.png`}
            alt="Quy tắc 1"
      ...
      <div className="relative flex flex-col md:flex-row-reverse items-center gap-16">
        ...
        <div className="md:w-1/2">
          <img
            src={`${import.meta.env.BASE_URL}images/rule-img2.png`}
            alt="Quy tắc 2"
            className="rounded-lg w-full"
          />
        </div>
