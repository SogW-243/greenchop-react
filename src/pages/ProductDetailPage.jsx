...
const dummyProduct = {
  ...
  images: [
    `${import.meta.env.BASE_URL}images/Donut.png`,
    `${import.meta.env.BASE_URL}images/Donut.png`,
    `${import.meta.env.BASE_URL}images/Donut.png`,
    `${import.meta.env.BASE_URL}images/Donut.png`,
  ],
            ...
            {activeTab === "details" && (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-12 gap-x-8">
                <div className="flex flex-col items-center text-center">
                  <img
                    src={`${import.meta.env.BASE_URL}images/item-img1.jpg`}
                    alt="Chất liệu xanh"
                ...
                <div className="flex flex-col items-center text-center">
                  <img
                    src={`${import.meta.env.BASE_URL}images/item-img2.jpg`}
                ...
                <div className="flex flex-col items-center text-center">
                  <img
                    src={`${import.meta.env.BASE_URL}images/item-img3.jpg`}
                    alt="Tiện lợi"
                    className="w-24 h-24 object-contain mb-4"
                  />
